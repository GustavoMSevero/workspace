 ...
 */
define('__THEMEDIR__', ossn_route()->themes . 'workspace/');

ossn_register_callback('ossn', 'init', 'ossn_workspace_theme_init');

function ossn_workspace_theme_init(){	
	//add bootstrap
	...
	ossn_extend_view('ossn/admin/head', 'ossn_workspace_admin_head');
	ossn_extend_view('ossn/site/head', 'ossn_workspace_head');
    ossn_extend_view('js/opensource.socialnetwork', 'js/workspace');	
}
function ossn_workspace_head(){
	$head	 = array();
...
function ossn_workspace_admin_head(){
	$head	 = array();	
	$head[]  = ossn_html_css(array(
					'href' => '//cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css',
			  ));	
